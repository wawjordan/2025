classdef zero_mean_basis2
    ...
    methods
        function this = zero_mean_basis2(n_dim,degree,h_ref,quad)
...
%%%%%%%%%%%%% figure out this discrepency
        ...
        function deriv = calc_basis_derivatives_vec_scale(this,n1,point,scale_vec)
            ...
            for j = n1+1:this.n_terms
                ...
                for i = 1:j-n1
                    ...
                    L = zero_mean_basis2.get_factorial_scaling_2(order,scale_vec);
                    deriv(i,j-n1) = L * derivative_term;
                end
            end
        end
    ...
    methods (Static)
        ...
        function exp = get_exponents_sorted( dimen, total_degree )
            n_terms = zero_mean_basis2.get_n_terms(dimen,total_degree);
            ...
            for n = 0:full_degree
                tmp_exp = zero_mean_basis2.global_to_local(n+1,nSub) - 1;
