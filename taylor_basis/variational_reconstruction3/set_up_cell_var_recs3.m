function CELLS = set_up_cell_var_recs3(GRID,blk,idx_low,idx_high,degree,funs,n1)
nvars = numel(funs);
...
CELLS = var_rec_t3.setup_all(n1,CELLS,funs);
end
...
T = zero_mean_basis3(n_dim,degree,h_ref,Q);
CELL = var_rec_t3(nbor_idx,nbor_face_id(1:n_nbor),bc_id,T,Q,FQ,FN,n_vars);
end
