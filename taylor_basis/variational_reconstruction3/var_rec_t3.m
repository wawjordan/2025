classdef var_rec_t3
    ...
    properties
        ...
        basis        (1,1)   zero_mean_basis3    % local basis functions
    ...
    methods
        function this = var_rec_t3(nbor_idxs,nbor_face_id,bc_id,T,Q,FQ,FN,n_vars)
            if nargin<1
                return
            end
    ...
    methods (Static)
        function A = construct_full_LHS_matrix(n1,CELLS)
            ...
            for i = 1:n_cells
                ...
                col_start = row_start;
                Ai = CELLS(i).self_LHS;
                [row_idx,col_idx,vals,nz_cnt] = var_rec_t3.add_array(row_idx,col_idx,vals,nz_cnt,row_start,col_start,Ai);
                ...
                for n = 1:n_nbors
                    ...
                    [row_idx,col_idx,vals,nz_cnt] = var_rec_t3.add_array(row_idx,col_idx,vals,nz_cnt,row_start,col_start,-Bij);
                end
            end
        ...
        function [CELLS,LHS,RHS,coefs] = perform_reconstruction(n1,CELLS)
            ...
            n_vars        = CELLS(1).n_vars;
            n_cells       = numel(CELLS);
            LHS = var_rec_t3.construct_full_LHS_matrix(n1,CELLS);
            RHS = var_rec_t3.construct_full_RHS(n1,CELLS);
