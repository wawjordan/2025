classdef coupled_constraint_t_old < constraint_generator_t_old
    methods
        function this = coupled_constraint_t_old( poly_degree, n_vars, dimen )
        ...
        function constraint_row = generate_constraint( this, poly, constraint_inputs )
            ...
            for vi = 1:size(constraint_inputs.VAR_IDX,1)
                var_constraint(:,vi) = poly.compute_linearization( constraint_inputs.x_eval ) * constraint_inputs.coupling_coeff(vi);
            end
