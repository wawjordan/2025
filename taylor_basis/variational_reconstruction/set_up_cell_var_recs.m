function CELLS = set_up_cell_var_recs(GRID,blk,idx_low,idx_high,degree,funs)
nvars = numel(funs);
...
CELLS = var_rec_t.setup_all(CELLS);
end
...
T = zero_mean_basis(n_dim,degree,h_ref,Q);
CELL = var_rec_t(nbor_idx,T,Q,FQ,FN,n_vars);
end
