classdef zero_mean_basis4
    ...
    methods
        function this = zero_mean_basis4(n_dim,degree,h_ref,quad)
        ...
        function x_bar = transform(this,x)
            ...
            x_bar = zero_mean_basis4.shift_and_scale_static( x(1:this.n_dim), this.x_ref, scale_factor );
        end
        ...
        function deriv = calc_basis_derivatives_vec_scale(this,n1,point,scale_vec)
            ...
            for j = n1+1:this.n_terms
                ...
                for i = 1:j-n1
                    ...
                    L = zero_mean_basis4.get_factorial_scaling_2(order,scale_vec);
    ...
    methods (Static)
        ...
        function exp = get_exponents_sorted( dimen, total_degree )
            n_terms = zero_mean_basis4.get_n_terms(dimen,total_degree);
            ...
            for n = 0:full_degree
                tmp_exp = zero_mean_basis4.global_to_local(n+1,nSub) - 1;
