classdef zero_mean_basis5
    ...
    methods
        function this = zero_mean_basis5(n_dim,degree,h_ref,quad)
        ...
        function x_bar = transform(this,x)
            ...
            x_bar = zero_mean_basis5.shift_and_scale_static( x(1:this.n_dim), this.x_ref, scale_factor );
        end
    ...
    methods (Static)
        ...
        function exp = get_exponents_sorted( dimen, total_degree )
            n_terms = zero_mean_basis5.get_n_terms(dimen,total_degree);
            ...
            for n = 0:full_degree
                tmp_exp = zero_mean_basis5.global_to_local(n+1,nSub) - 1;
