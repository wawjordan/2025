%% Generate family of Curvilinear grids (06/28/2023)
clc; clear; close all;
...
% function x = xFunc2D(xi,eta)
% x = 0.1*sin( (2.0-xi)*pi.*eta) + 0.1*eta + xi;
% end
% 
% function y = yFunc2D(xi,eta)
% y = -0.1*sin( (2.0+eta)*pi.*xi) - 0.1*xi + eta;
% end
% 
% function x = xFunc3D(xi,eta,zeta)
% x =  0.10*sin( (2-xi)*pi .*  eta ) ...
