%% KT airfoil test case grid coarsening from pointwise (07/23/2026)
clc; clear; close all;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
parent_dir_str = '2025';
...
folder =         'C:\Users\wajordan\Downloads\kt_TE10_AR_1_1_d-1-8_ALPHA_05';
fine_grid_file = 'C:\Users\wajordan\Downloads\kt_TE10_AR_1_1_d-1-8_ALPHA_05\grids2\kt_mod.x';
...
out_folder = fullfile(folder,'\grids2\');
